...
class MainActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val occupationAdapter: ArrayAdapter<*> = ArrayAdapter<Any?>(this, android.R.layout.simple_spinner_item, occupations)
        ...
        submitBtn.setOnClickListener {
            ...
            // Validate Salary (valid number)
            if (salaryInput.isEmpty()) {
                findViewById<EditText>(R.id.salaryText).error = "Salary is required"
                return@setOnClickListener
            }
